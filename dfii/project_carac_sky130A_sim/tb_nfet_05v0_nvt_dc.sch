...
save v(vgs)
save i(VDS)
save @m.xm1.msky130_fd_pr__nfet_05v0_nvt[vth]
save @m.xm1.msky130_fd_pr__nfet_05v0_nvt[vdsat]

dc VGS -0.5 5.0 0.005

let id = -i(VDS)
let vth = @m.xm1.msky130_fd_pr__nfet_05v0_nvt[vth]
let vdsat = @m.xm1.msky130_fd_pr__nfet_05v0_nvt[vdsat]

set wr_singlescale
set wr_vecnames

wrdata tb_nfet_05v0_nvt_dc.dat v(vgs) id vth vdsat

.endc"}
C {sky130_fd_pr/nfet_05v0_nvt.sym} 1280 -1390 0 0 {name=M1
W=WDEV
L=LDEV
nf=1
mult=1
