...
DC_FILE = ROOT / "work/tb_nfet_03v3_nvt_dc.dat"
OUTPUT_FILE = ROOT / "work/tb_nfet_03v3_nvt_id_vds.dat"
...
plt.savefig(
    OUT / "nfet_03v3_nvt_id_vs_vgs.pdf",
    bbox_inches="tight"
)
...
gate_values = np.arange(0.0, 3.01, 0.5)
...
plt.savefig(
    OUT / "nfet_03v3_nvt_id_vs_vds.pdf",
    bbox_inches="tight"
)
...
print()
print("Generated:")
print(OUT / "nfet_03v3_nvt_id_vs_vgs.pdf")
print(OUT / "nfet_03v3_nvt_gmid.pdf")
print(OUT / "nfet_03v3_nvt_id_vs_vds.pdf")
